...
class Solution:
        ...
        for j in range(len(grid)):
            for i in range(len(grid[0])):
                ...
                if (j,i) in visited:
                    ...
                    visited.append((j,i))
                #This is an island. Perform BFS and add all coord of island to visited.
                else:
                    #print('entering bfs area',j,i)
    ...
    #This bfs needs to return all coordinates for one island
        ...
        while queue:
            ...
            for ea_dir in possible_directions:
                ...
                if new_coord[0]>=0 and new_coord[0] < len(grid) and new_coord[1] < len(grid[0]) and new_coord[1] >= 0:
                    ...
                    if new_coord not in bfs_visited and grid[new_coord[0]][new_coord[1]] == '1': 
